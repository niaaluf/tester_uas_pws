...
import testeruas.test.pws.exceptions.NonexistentEntityException;
import testeruas.test.pws.exceptions.PreexistingEntityException;
...
public class MahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("testeruas_test.pws_jar_0.0.1-SNAPSHOTPU");
